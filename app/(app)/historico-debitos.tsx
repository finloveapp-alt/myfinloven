...
export default function HistoricoDebitos() {
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.emptyStateContainer}>
          <Text style={styles.emptyStateText}>
            Nenhum {selectedType.toLowerCase().slice(0, -1)} encontrado para os filtros selecionados.
          </Text>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  summaryValuePaid: {
    fontSize: 24,
    fontFamily: fontFallbacks.Poppins_600SemiBold,
    color: '#4CD964', // Verde para valores pagos
  },
  summaryValuePending: {
    fontSize: 24,
    fontFamily: fontFallbacks.Poppins_600SemiBold,
    color: '#b687fe', // Roxo para valores pendentes
  },
  emptyStateContainer: {
    alignItems: 'center',
